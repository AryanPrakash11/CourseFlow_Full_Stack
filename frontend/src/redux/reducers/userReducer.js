...
export const userReducer = createReducer(
  ...
  {
    loginRequest: state => {
      // loader chlta rhega jbb tkk data aa na jaye kyoki async fun hai user.js file
      // me dekho wha data fetch kr rha hai axios ke madad se then show krwa rha hai.
      state.loading = true;
    },
    loginSuccess: (state, action) => {
      ...
      // yha wala user backend me /login route pe aayega backend me check kro wha
      // pe bna hoga login 
